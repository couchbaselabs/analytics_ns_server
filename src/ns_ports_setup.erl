...
cbas_spec(Config) ->
    ...
    case CBASCmd =/= false andalso
        ...
        _ ->
            ...
            CBASCCHttpPort = ns_config:search(Config, {node, node(), cbas_cc_http_port}, 9111),
            CBASAuthPort = ns_config:search(Config, {node, node(), cbas_auth_port}, 9119),
            CBASAdminPort = ns_config:search(Config, {node, node(), cbas_admin_port}, 9110),
            ...
            Spec = {cbas, CBASCmd,
                    [
                     ...
                     "-bindAdminPort=" ++ integer_to_list(CBASAdminPort),
